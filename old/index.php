                                ...
                                <div class="swiper-wrapper">
                                    ...
                                    <div class="swiper-slide">
                                        ...
                                        <div class="hero-item fl-wrap">
                                            <div class="container">
                                                <a class="post-category-marker" href="single-post?id=<?php echo $id ?>"><?php echo $cat_name; ?> </a>
                                                <div class="clearfix"></div>
                                                <h2><a href="single-post?id=<?php echo $id ?>"><?php echo $header; ?></a></h2>
                                                                        ...
                                                                        <div class="bg-wrap" id="mydiv">
                                                                            <?php
                                                                                ...
                                                                                while ($fetRow=$select->fetch()) {
                                                                                    ...
                                                                                    ?>
                                                                                    <!-- <img src="images/all/<?php// echo $advImage ?>" alt="" srcset=""> -->
