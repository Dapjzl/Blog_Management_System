                                    ...
                                    <div class="footer-widget">
                                        ...
                                        <div class="footer-widget-content">
                                            <div class="subcribe-form fl-wrap">
                                                ...
                                                <form id="form-wizard4" method="POST" class="fl-wrap">
                                                    <input class="enteremail" id="emInput" name="subEmail2" placeholder="Your Email" spellcheck="false" type="text">
                                                    <button style="color: #e93314; background-color:#fff;" type="submit" class="subscribe-button">Send </button>
                                                    <!-- <label for="subscribe-email" class="subscribe-message"></label> -->
                                                    <p id="form-message-2"></p>
                                                </form>
...
<script>
    $(document).ready(function(){
        $("#form-wizard4").submit(function(event){
