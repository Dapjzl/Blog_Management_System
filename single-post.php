...
<?php
    ...
    while($row=mysqli_fetch_assoc($result)) {
        ...
        $query2 = "SELECT * FROM category WHERE id=$categorynew";
        $result2 = mysqli_query($connect,$query2);
        $ro = mysqli_fetch_assoc($result2);
        $cat_name = $ro['cat_name'];

        $explodeeded = explode(".",$image);
        $explode = end($explodeeded);

        $checkHtml = html_entity_decode($description); 

    }

?> 
    <meta property="og:url" content="https://lead360.ng/single-post.php?id=<?php echo $id ?>" />
    <meta property="og:title" content="<?php echo $title ?>" />
    <meta property="og:description" content="" />
    <meta property="og:image" content="https://www.lead360.ng/lead360_Admin/uploads/<?php echo $image?>" />
    <meta property="og:image:secure_url" content="https://www.lead360.ng/lead360_Admin/uploads/<?php echo $image?>" />
    <meta property="og:image:width" content="400" />
    <meta property="og:image:height" content="400" />
    <meta property="og:image:type" content="image/<?php echo $explode ?>" />
                                        ...
                                        <div class="more-post-wrap  fl-wrap">
                                            ...
                                            <div class="list-post-wrap list-post-wrap_column fl-wrap">
                                                <div class="row">
                                                    ...
                                                    $query12 = "SELECT * FROM post Where id!=$id AND cat_id='$categorynew' order by rand() LIMIT 2";
